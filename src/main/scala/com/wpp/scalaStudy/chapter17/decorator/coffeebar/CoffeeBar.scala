package com.wpp.scalaStudy.chapter17.decorator.coffeebar

import com.wpp.scalaStudy.chapter17.decorator.coffeebar.mycoffee.{DeCaf, LongBlack}
import com.wpp.scalaStudy.chapter17.decorator.coffeebar.mydecorator.{Chocolate, Milk, NewMilk}
